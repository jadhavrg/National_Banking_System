...
<title>Customer profile update page</title>
<style type="text/css">
...
<body>
			...
			<form action="customerUpdateProfile" method="post">
				...
				<p><b>Here, we can update only your name and phone number.</b></p>
				<%
					long accountNumber = (Long) session.getAttribute("customeraccountnum") ;	
					out.println("Your account number: " + accountNumber) ;
					
				%> <br><br>
				Enter New Name <input type="text" name="name" placeholder="Enter name..." Required> <br><br>
				Enter New Phone Number: <input type="number" name="phone" placeholder="Enter phone number..."> <br><br>
				<input type="submit" value="Update profile" class="btn"> <br><br>
			</form>
