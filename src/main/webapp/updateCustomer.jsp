...
<body>
		...
		<div>
			<form action="customerupdatepassword" method="post">
				...
				%> <br><br> 
				Enter Old Pincode: <input type="password" name="pincode" placeholder="Enter old pincode.." Required> <br><br>
				Enter New Pincode: <input type="password" name="Newpincode" placeholder="Enter new pincode.." Required> <br><br>
